  ...
  return (
    <div className="shell py-10">
      ...
      <div className="mt-8 overflow-hidden rounded-[32px] border border-[var(--border)] bg-white">
        <div className="hidden grid-cols-6 gap-4 border-b border-[var(--border)] px-6 py-4 text-xs font-semibold uppercase tracking-[0.16em] text-[var(--muted)] md:grid">
          <span>Property</span>
          <span>Role</span>
          <span>Status</span>
          <span>Amount</span>
        ...
        {transactions.length ? (
          transactions.map((transaction) => (
            <div
              ...
              className="grid grid-cols-1 gap-3 border-b border-[var(--border)] px-6 py-5 text-sm last:border-b-0 md:grid-cols-6 md:items-center"
            >
