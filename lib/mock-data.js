...
export const dashboardPanels = [
  {
    ...
    badge: "Buyer",
    description: "Everything needed to browse listings, track rent payments, and keep wallet actions visible in one place.",
    items: ["Marketplace shortcuts", "ETH payment status", "Notifications and reminders", "Profile and wallet summary"],
    href: "/transactions"
  },
  {
  ...
  },
  {
    ...
    title: "Wallet and contract tools",
    badge: "Web3",
    description: "Reusable connection and contract helpers live behind this dashboard path so the app can grow safely.",
    items: ["MetaMask connection", "Sepolia address config", "ethers contract helper", "Transaction hash tracking"],
    href: "/wallet"
  }
];
